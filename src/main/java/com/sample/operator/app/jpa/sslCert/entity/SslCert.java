...
//    @Column(columnDefinition = "varchar(255) character set utf8 collate utf8_bin")
    ...
    // 생성자
    public SslCert(X509Certificate cert, String purpose, String svc, String subSvc)
    {
        CertSvcGroup svcGroup =  CertSvcGroup.builder().svcGroupName(svc).subSvcName(subSvc).certPurpose(purpose).build();
